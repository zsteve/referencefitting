...
def Model(Y,t,pars):
    ...
    a_Scl_Gata1 = pars[77]
    a_Scl_Pu1 = pars[78]
    a_Scl_Pu1_Gata1 = pars[79]
    a_cJun_Gfi1 = pars[80]
    a_cJun_Pu1 = pars[81]
    a_cJun_Pu1_Gfi1 = pars[82]
    alpha_Cebpa = pars[83]
    alpha_EgrNab = pars[84]
    alpha_Eklf = pars[85]
    alpha_Fli1 = pars[86]
    alpha_Fog1 = pars[87]
    alpha_Gata1 = pars[88]
    ...
    r_Scl = pars[158]
    r_cJun = pars[159]
    sigmaH_Cebpa = pars[160]
    sigmaH_EgrNab = pars[161]
    sigmaH_Eklf = pars[162]
    sigmaH_Fli1 = pars[163]
    sigmaH_Fog1 = pars[164]
    sigmaH_Gata1 = pars[165]
    sigmaH_Gata2 = pars[166]
    sigmaH_Gfi1 = pars[167]
    sigmaH_Pu1 = pars[168]
    sigmaH_Scl = pars[169]
    sigmaH_cJun = pars[170]
    # Variables
    x_Gata2 = Y[0]
    p_Gata2 = Y[1]
    x_Gata1 = Y[2]
    ...
    dx_Fog1 = m_Fog1*(( alpha_Fog1 + a_Fog1_Fog1*(p_Fog1/k_Fog1)**n_Fog1 )/( 1 +(p_Fog1/k_Fog1)**n_Fog1 ))-l_x_Fog1*x_Fog1
